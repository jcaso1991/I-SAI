...
const FAQ: FAQItem[] = [
  ...
  // ═══════════ PROYECTOS ═══════════
  { q: "¿Cómo creo un proyecto nuevo?", r: "1. Ve a 'Proyectos' en el menú lateral o módulos centrales.\n2. Pulsa el botón '+' en la esquina superior derecha.\n3. Rellena: código del proyecto, cliente, ubicación, horas previstas, comercial y gestor.\n4. Pulsa 'Crear'.\n\nTambién puedes crear proyectos desde la importación Excel o sincronizando con Google Sheets.", tags: ["proyectos"], keywords: ["crear", "nuevo", "proyecto", "obra", "alta", "añadir"], route: "/materiales", routeLabel: "Ir a Proyectos", perm: "proyectos.view" },
  ...
  { q: "¿Cómo ordeno los proyectos por fecha?", r: "En la lista de Proyectos hay un botón de ordenar (flechas). Ábrelo para elegir: fecha de alta (más reciente/antigua) o fecha de planificación (próxima/lejana). También puedes quitar el orden con 'Sin orden'.", tags: ["proyectos"], keywords: ["ordenar", "fecha", "alta", "planificación", "orden", "cronológico", "reciente", "antiguo", "ordenar por fecha"], route: "/materiales", routeLabel: "Ir a Proyectos", perm: "proyectos.view" },
  { q: "¿Qué vistas tiene el módulo Proyectos?", r: "Arriba del listado hay un selector con tres vistas:\n• Lista: las tarjetas en vertical\n• Tablero: columnas por estado (Pendiente → Planificado → A facturar → Facturado → Terminado)\n• Calendario: los proyectos aparecen en el día de su fecha de planificación, con navegación entre meses y botón 'Hoy'.\n\nToca un proyecto en cualquier vista para editarlo.", tags: ["proyectos"], keywords: ["vista", "tablero", "kanban", "calendario", "columnas", "lista"], route: "/materiales", routeLabel: "Ir a Proyectos", perm: "proyectos.view" },
  { q: "¿Cómo edito un proyecto rápido sin abrir la ficha?", r: "Toca una tarjeta de proyecto: se abre un panel rápido donde puedes cambiar el estado, la fecha de planificación, si el material está pedido (Sí/No) y las notas. Pulsa 'Guardar' y listo. Si necesitas más campos, usa 'Ver ficha completa'.", tags: ["proyectos"], keywords: ["editar", "rápido", "estado", "planificación", "pedido", "notas", "tarjeta"], route: "/materiales", routeLabel: "Ir a Proyectos", perm: "proyectos.view" },
  { q: "¿Cómo uso el bloc de notas del cuadro de mando de Proyectos?", r: "En el panel lateral izquierdo del cuadro de mando de Proyectos (vista Lista) hay una sección 'NOTAS' debajo de 'Responsables'. Escribe una anotación y pulsa el botón '+' para guardarla. Las anotaciones quedan guardadas en el backend y se comparten entre los usuarios con acceso. Para borrar una, pulsa el icono 'X' junto a la nota.", tags: ["proyectos"], keywords: ["notas", "bloc", "anotación", "cuadro", "mando", "panel", "lateral", "recordatorio"], route: "/materiales", routeLabel: "Ir a Proyectos", perm: "proyectos.view" },

  // ═══════════ CALENDARIO ═══════════
  { q: "¿Cómo genero una certificación sin precios?", r: "En el formulario de certificación hay un check 'Sin precios' arriba del todo. Al marcarlo:\n• El formulario oculta las columnas de precios (P.U. y Total) y la sección de totales\n• Solo quedan los materiales con sus cantidades (alcance y ejecutado)\n• El PDF generado tampoco incluye las columnas de precios ni los totales\n\nPor defecto viene desmarcado, para que los precios se muestren normalmente.", tags: ["proyectos", "certificaciones"], keywords: ["certificación", "sin precios", "ocultar", "precio", "materiales", "pdf"], route: "/materiales", routeLabel: "Ir a Proyectos", perm: "certificaciones.view" },
